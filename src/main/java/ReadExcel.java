...
//            申明一个二维数组用于接受表每行的空喉半径与汞增量；
            ...
            //创建工作簿对象
            XSSFWorkbook xssfWorkbook = new XSSFWorkbook(new FileInputStream("E:\\IDEA.2022.3.2\\Workplace\\DateProcess\\src\\main\\resources\\DataList\\WC8-3N-1(1-7).xlsx"));
            //获取工作簿下sheet的个数
...
//                        System.out.println("（"+list[n] +","+ operationalData.DataOperat(x1, x2, y1, y2, list[n])+")");
