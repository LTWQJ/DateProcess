...
public class ReadExcel {
    ...
    public static void main(String[] args) {
        ...
        for (String str:fileList){
            try {
                GetDifferentCurves.GeneratedData(str);
                System.out.println(str);
            } catch (FileNotFoundException e) {
                throw new RuntimeException(e);
            }
        }
        System.out.println("共计"+fileList.size()+"数据操作已经完成");
        /*try {
            List<String> fileList = getFilePath.getFilePath("E:\\IDEA.2022.3.2\\Workplace\\算法练习\\DateProcess\\src\\main\\resources\\DataList");
            for (String str:fileList){
                System.out.println(str);
            }
//            要分析的表数据地址
            String path="E:\\IDEA.2022.3.2\\Workplace\\算法练习\\DateProcess\\src\\main\\resources\\DataList\\WC8-3N-1(1-10).xlsx";
